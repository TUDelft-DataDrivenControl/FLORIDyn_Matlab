...
%   Averaging rate increases with decreased distance between OPs
...
%   Wind Field
%       TODO: Determine weights depending on distance of OPs to oneanother
warning('Buffer Iteration not implemented as intended!')
...
for iT=1:T.nT
    ...
    if ~issorted(indOP)
        ...
        newFaster =  T.States_WF(T.StartI(iT) + newInd,:)  > ...
