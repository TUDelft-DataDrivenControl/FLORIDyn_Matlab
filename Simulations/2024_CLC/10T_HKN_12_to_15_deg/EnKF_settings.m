...
%   The wind direction measurements can be retrieved from probes in the LES 
%   or similar measurement signals, or can be read from the data that is 
%   stored in the simulation folder.
%   Simulation Data:      'Sim Data'
%   Probes data:          'CLC Probes Turbine Individual'
%   Probes data averaged: 'CLC Probes Averaged'
EnKF.Dir.MeasurementSource = 'Sim Data';
EnKF.Dir.PathToProbeFile   = '/home/marcusbecker/OpenFOAM/marcusbecker-2.4.0/simulationCases/2024_CLC/HKN_12_to_15h_177deg/postProcessing/turbine_probe/31000/U';
%   If probe data is used, the measurements of the past seconds are averaged
%   This is done probe individual.
EnKF.Dir.MeasurementAverageTime = 60; %in s
%   If probe data is used, a default measurement is used as replacement if
%   no values are written yet. If this is the case, an non-crashing error 
%   message is displayed as well.
EnKF.Dir.MeasurementDefault = 225;

EnKF.Dir.MeasurementNoise = 3; % Deg
